...
const config = {
    ...
    instagram: 'https://instagram.com/perusak.game_',
    nomer: 'wa.me/628989031500',
    aktif: 'TERGANTUNG OWNER',
    youtube: 'https://youtube.com',
    whatsapp: 'https://chat.whatsapp.com/D8YpSLQWvh6AYLyn5HnSB',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ]  MIMIN X BOT BY INR!!!`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by :@INR21_`)
})
